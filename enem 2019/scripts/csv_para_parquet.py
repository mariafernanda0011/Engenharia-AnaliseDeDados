...
csv_path = "C:/Users/PC/Documents/ProjetoBDII/dados/MICRODADOS_ENEM_2019.csv"
output_parquet_dir = "parquet_chunks"
output_csv_path = "MICRODADOS_ENEM_2019_saida.csv"
output_parquet_path = "MICRODADOS_ENEM_2019_saida.parquet"
...
if usar_amostra:
    ...
    for chunk in leitor_chunks:
        parquet_path = os.path.join(output_parquet_dir, f"MICRODADOS_ENEM_2019_chunk_{numero_chunk}.parquet")
